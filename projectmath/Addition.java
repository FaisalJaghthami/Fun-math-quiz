...
public class Addition implements ActionListener{
     public JFrame Additionframe,scoreframe;
     public JPanel Additionpanel,scorepanel;
    ...
    public Addition(){
        //creating the questions
         ...
         Additionframe = new JFrame();
         Additionframe.setSize(700, 300);
         Additionframe.setLayout(new BorderLayout());
         Additionframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         Additionframe.setTitle("Fun Math Quiz, Addition!");
