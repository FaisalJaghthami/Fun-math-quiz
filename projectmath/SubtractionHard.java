...
public class SubtractionHard implements ActionListener{
     public JFrame SubtractionHardframe,scoreframe;
     public JPanel SubtractionHardpanel,scorepanel;
     public JTextField aq1,aq2,aq3,aq4,aq5;
     public JLabel q1,q2,q3,q4,q5,scorelabel;
     public JButton score;
     public String c,f,i,l,o;
     
    public SubtractionHard(){
        //creating the questions
         ...
         SubtractionHardframe = new JFrame();
         SubtractionHardframe.setSize(700, 300);
         SubtractionHardframe.setLayout(new BorderLayout());
         SubtractionHardframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         SubtractionHardframe.setTitle("Fun Math Quiz, Subtraction!");
         
         //creating the panel
         SubtractionHardpanel = new JPanel();
         SubtractionHardpanel.setLayout(null);
         SubtractionHardpanel.setBackground(Color.cyan);
               

         //adding question one to the panel
         q1=new JLabel(a+" "+"-"+" "+b+" "+"= ");
         q1.setBounds(290, 20, 60, 20);
         SubtractionHardpanel.add(q1);
         //addint the answer's textfield
         aq1=new JTextField();
         aq1.setBounds(350, 20, 50, 20);
         SubtractionHardpanel.add(aq1);
         
         //adding question two to the panel
         q2=new JLabel(d+" "+"-"+" "+e+" "+"= ");
         q2.setBounds(290, 50, 60, 20);
         SubtractionHardpanel.add(q2);
         //addint the answer's textfield
         aq2=new JTextField();
         aq2.setBounds(350, 50, 50, 20);
         SubtractionHardpanel.add(aq2);
         
         //adding question three to the panel
         q3=new JLabel(g+" "+"-"+" "+h+" "+"= ");
         q3.setBounds(290, 80, 60, 20);
         SubtractionHardpanel.add(q3);
         //addint the answer's textfield
         aq3=new JTextField();
         aq3.setBounds(350, 80, 50, 20);
         SubtractionHardpanel.add(aq3);
         
         //adding question four to the panel
         q4=new JLabel(j+" "+"-"+" "+k+" "+"= ");
         q4.setBounds(290, 110, 60, 20);
         SubtractionHardpanel.add(q4);
         //addint the answer's textfield
         aq4=new JTextField();
         aq4.setBounds(350, 110, 50, 20);
         SubtractionHardpanel.add(aq4);
         
         //adding question five to the panel
         q5=new JLabel(m+" "+"-"+" "+n+" "+"= ");
         q5.setBounds(290, 140, 60, 20);
         SubtractionHardpanel.add(q5);
         //addint the answer's textfield
         aq5=new JTextField();
         aq5.setBounds(350, 140, 50, 20);
         SubtractionHardpanel.add(aq5);

         //creating the get score button
         score = new JButton("Get Score!");
         score.addActionListener(this);
         score.setBounds(300,180, 100, 20);
         SubtractionHardpanel.add(score);
         
         //adding the JPanel and it's components to the JFrame
         SubtractionHardframe.add(SubtractionHardpanel);
         SubtractionHardframe.setVisible(true);  
    }
